...
* ```:3.17.0-4.9.2-r4``` 3.17.0-4.9.2-r4 branch based (Automatic Architecture Selection)
* ```:3.17.0-4.9.2-r4-aarch64```   3.17.0 64 bit ARM
* ```:3.17.0-4.9.2-r4-armhf```     3.17.0 32 bit ARM v6
* ```:3.17.0-4.9.2-r4-armv7```     3.17.0 32 bit ARM v7
* ```:3.17.0-4.9.2-r4-ppc64le```   3.17.0 64 bit PowerPC
* ```:3.17.0-4.9.2-r4-x86```       3.17.0 32 bit Intel/AMD
* ```:3.17.0-4.9.2-r4-x86_64```    3.17.0 64 bit Intel/AMD
...
***
###### Last Update 22.12.2022 04:10:46
