...
The Docker images [(maurosoft1973/alpine-lftp)](https://hub.docker.com/r/maurosoft1973/alpine-lftp/) is based on the minimal [Alpine Linux](https://alpinelinux.org/)  with [LFTP Version v%LFTP_VERSION%](https://lftp.yar.ru/).

##### Alpine Version %ALPINE_VERSION% (Released %ALPINE_VERSION_DATE%)
##### LFTP Version %LFTP_VERSION% (Released %LFTP_VERSION_DATE%)
